...
$parse['online_list'] .= "<tr><th class=b colspan=4>Jest {$i} uzytkownik(ow) ONLINE</th></tr>";




display(parsetemplate(gettemplate('oparator/overview_body'), $parse),"Overview",true);

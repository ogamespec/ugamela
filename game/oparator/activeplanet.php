...
if($user['authlevel']!="4"&&$user['authlevel']!="1"){ header("Location: ../login.php");}
$dpath = (!$user["dpath"]) ? DEFAULT_SKINPATH : $user["dpath"];
includeLang('overview');
$parse = $lang;
$parse['dpath'] = $dpath;
$parse['mf'] = $mf;
$parse['version'] = @file_get_contents('?v='.VERSION);
...
$parse['online_list'] .= "<tr><th class=b colspan=4>Jest aktywnych {$i} planet.</th></tr>";
display(parsetemplate(gettemplate('oparator/activeplanet_body'), $parse),"activeplanet",true);

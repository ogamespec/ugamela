...
if($userrow['authlevel'] != 4&&$userrow['authlevel'] != 4){
	admin_ask_password();
}
...
function admin_ask_password(){
	...
	$dat = "<form action=go.php method=post>
...
<table>
<tr><td class="c">GAMELA Administration</td></tr>
<tr><td class="b">Welcome to the administration of GAMELA</td></tr>
<tr><td class="c">Users Menu</td></tr>
<tr><td class="b"><a href="go.php?mode=listusers">Userlist</a></td></tr>
...
<td class=b><a href=\"go.php?mode=edituser&id={$u['id']}\">{$u['username']}</a></td>
...
function edituser($id){
	...
	*/
	...
	if($_POST){
		...
		error("succefull<br><a href=go.php?mode=listusers>back</a>",$lang['Options']);
...
<form action="go.php?mode=edituser&id={$u['id']}" method="post">
 <table width="519">
...
<tr>
  ...
  <tr>
   <th>{$lang['skins_example']}<br> <a href="/images" target="_blank">{$lang['Download']}</a></th>

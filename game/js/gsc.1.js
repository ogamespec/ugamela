...
s=s.replace(/#9/g,'\"><img src=\"images/img/e.gif\" border=0 alt=\"'+a+' Sonde schicken\">    </a>');
s=s.replace(/#b/g,'<a href=\"galaxy.php?mode=1&p1='+p1+'&p2='+p2+'&ft3=');
s=s.replace(/#c/g,'\"><img src=\"images/img/r.gif\" border=0 alt=\"Raketenangriff\">    </a>');


s=s.replace(/#4/g,'<a href=\"messages.php?mode=write&id=');
s=s.replace(/#5/g,'\"><img src=\"images/img/m.gif\" border=0 alt=\"Nachricht schreiben\"></a><a href=\"buddy.php?a=2&u=');
s=s.replace(/#X/g,'\"><img src=\"images/img/b.gif\" border=0 alt=\"Buddyanfrage\"></a>');
s=s.replace(/#6/g,'</th>');
s=s.replace(/#7/g,'<th>');

...
/*
  Perberos escribio:
	...
	Corregi un pequeÃ±o bug en los tiempos que se muestran en la lista de flotas.
	...
	*/
	...
	$page .= '
	  ...
	  <center>
		<table width="519" border="0" cellpadding="0" cellspacing="1">
		  <tr height="20">
			<td colspan="4" class="c">Yeni Görev: Uzay gemilerini secmek</td>
		  </tr>
		  <tr height="20">
			<th>Gemi Ismi</th>
			<th>Mevcut</th>';
	...
	/*
	  Pequeï¿½o loop para mostrar las naves que se encuentran en el planeta.
	*/
	...
	if(!$have_ships){
		...
		*/
		...
		$page .= '
		  <tr height="20">
			...
			<th colspan="2"><a href="javascript:maxShips();shortInfo();" >Tüm gemiler</a></th>
		  </tr>';
	  ...
	  <div id="xform" style="display:none;"><center>
		...
		$page .= '
		  <tr height="20">
			<td colspan="2" class="c">Geliþmiþ</td>
		  </tr>
		  <tr height="20">
		...
		$page .= '<option value="2"'.(($t==2)?" SELECTED":"").">Çöplük</option>";
		...
		$page .= '
		  ...
		  <th width="50%"><input name="resource3" type="text" alt="Deuterium'.floor($planetrow["deuterium"]).'" size="21" onChange="calculateTransportCapacity();" /></th>
		   ...
		   <tr height="20">
	  <th>Kalan Depo Alaný</th>
		  <th colspan="2"><div id="remainingresources">-</div></th>
		 </tr>      
		 <tr height="20">
	  <th colspan="2"><a href="javascript:noResources()">Boþalt</a></th>
	  <th><a href="javascript:maxResources()">All Resources</a></th>
		...
		$page .= '	  
		  ...
		  <tr height="20">
			<td colspan="2" class="c">Konfederasyon Savaþý
		  </tr>
		  <tr height="20">
			<th colspan="2">-</th>
		  </tr>

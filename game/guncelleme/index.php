...
$page = <<<HTML
	  ...
	  <td class=l>
Je&#347;li masz problem, wy&#347;lij mail'a do <b><font color="#7f7f7f">http://bugs.perberos.com.ar</font></b>. Albo u¿yj <a href="http://ugamela.perberos.com.ar/index.php?act=viewforum&f=17" target="_new">forum</a>.<br>
...
Forum na <a href="http://ugamela.perberos.com.ar/" target="_new">http://ugamela.perberos.com.ar/</a><br>
<br>
<br>
<font color="orange">Naprawienia</font>:
<lu>
	...
	<li><a href="r51-homeplanet_fields_dbfix.php">r51-homeplanet_fields_dbfix</a>
		<font color="#7f7f7f">
			AddOn to select homeplanet fields initial.
		</font>
	</li>
	...
	<li><a href="floty.php">Floty</a>
		<font color="#7f7f7f">
	Poprawka Flot
		</font>
	</li>
	<li><a href="zawracanie.php">Zawracanie floty</a>
		<font color="#7f7f7f">
			Poprawka umo¿liwiaj±ca zawrócenie floty (by DxPpLmOs).
		</font>
	</li>
	<li><a href="gala.php">Galaktyka</a>
		<font color="#7f7f7f">
			Poprawka galaktyki (by DxPpLmOs).
		</font>
	</li>
</lu>
	</td>

...
$flota_atakujaca=$flota_atakujaca."</tr><tr><td>Zirhlar</td>";	
$pom1=0;
while ($pom1<count($flota_agresor))
{
...
$tresc_raportu="Servernden Rapor:<br><br>Filo Saldiri icin Yaklasti<br>".
"Uzbrojenie: ".$bojowa_ag."%
Pancerz: ".$pancerz_ag."%
Tarcza: ".$tarcza_ag."%
...
$tresc_raportu=$tresc_raportu."<br>Silahlar: ".$bojowa_ob."%<br>Zirhlar: ".$pancerz_ob."%<br>Koruma: ".$tarcza_ob."%";
...
$p1++;
	...
	$tresc_raportu=$tresc_raportu."</tr><tr><td>Silahlar</td>";
	$pom1=0;
...
if ($cel["stan"]!=1)
	...
	if ($sprawne_obronca==0) ($tresc_raportu=$tresc_raportu."<br>Saldirilan Taraf Yok Edildi!!!<br>");
	
	
	$tresc_raportu=$tresc_raportu."<br>Saldirilanin Tarafin Defansi: ".$pochloniecie_tarcza_obronca."Puan <br>";
	$tresc_raportu=$tresc_raportu."<br>Saldirilanin Tarafin Zirhi: ".$pochloniecie_pancerz_obronca."Puan <br>";
...
$surka="<table width=400><tr><td class=c colspan=4> Hammadde {$idwroga['name']}[{$idwroga['galaxy']}:{$idwroga['system']}:{$idwroga['planet']}]".gmdate("d-m-Y H:i:s",time())."</td></tr><tr><td>Metal:</td><td>".pretty_number($idwroga['metal'])."</td><td>Crystal:</td><td>".pretty_number($idwroga['crystal'])."</td></tr> <tr><td>Deuter:</td><td>".pretty_number($idwroga['deuterium'])."</td> <td>Enerji:</td><td>".pretty_number($idwroga['energy_max'])."</td></tr> </table>";
...
if($idwroga['battle_ship'] > "0"){$panc="<td>Firkateyn</td><td>{$idwroga['battle_ship']}</td></tr>";}
//if($idwroga['silo'] > "0"){$silos="<td>Silo Gemisi</td><td>{$idwroga['silo']}</td></tr>";}

$floty="<table width=400><tr><td class=c colspan=4> Hammadde {$idwroga['name']}[{$idwroga['galaxy']}:{$idwroga['system']}:{$idwroga['planet']}]".gmdate("d-m-Y H:i:s",time())."</td></tr><tr><td>Metal:</td><td>".pretty_number($idwroga['metal'])."</td><td>Crystal:</td><td>".pretty_number($idwroga['crystal'])."</td></tr> <tr><td>Deuter:</td><td>".pretty_number($idwroga['deuterium'])."</td> <td>Enerji:</td><td>".pretty_number($idwroga['energy_max'])."</td></tr> </table><table width=400><tr><td class=c colspan=6>Filo</td></tr>$mt$dt$lm$cm$kr$ow$colon$recek$spysonda$bombo$satki$niszcz$gwiazdeczka$panc </table>";
...
if($idwroga['big_laser'] > "0"){$bl="<td>Agir Lazer</td><td>{$idwroga['big_laser']}</td>";}
...
if($idwroga['small_protection_shield'] > "0"){$mp="<td>Hafif Koruma Kalkani</td><td>{$idwroga['small_protection_shield']}</td>";}
if($idwroga['big_protection_shield'] > "0"){$dp="<td>Agir Koruma Kalkani</td><td>{$idwroga['big_protection_shield']}</td>";}


$obrona="<table width=400><tr><td class=c colspan=4> Hammadde {$idwroga['name']}[{$idwroga['galaxy']}:{$idwroga['system']}:{$idwroga['planet']}]".gmdate("d-m-Y H:i:s",time())."</td></tr><tr><td>Metal:</td><td>".pretty_number($idwroga['metal'])."</td><td>Crystal:</td><td>".pretty_number($idwroga['crystal'])."</td></tr> <tr><td>Deuter:</td><td>".pretty_number($idwroga['deuterium'])."</td> <td>Energia:</td><td>".pretty_number($idwroga['energy_max'])."</td></tr> </table><table width=400><tr><td class=c colspan=6>Filo</td></tr>$mt$dt$lm$cm$kr$ow$colon$recek$spysonda$bombo$satki$niszcz$gwiazdeczka$panc </table> <table width=400><tr><td class=c colspan=4>Defans</td></tr>$ml$sl$bl$gauss$ionic$buster$mp$dp </table>";
...
if($idwroga['solar_plant'] > "0"){$solar="<td>Solar Enerrji Santrali</td><td>{$idwroga['solar_plant']}</td>";}
...
$budynki="<table width=400><tr><td class=c colspan=4> Hammadde {$idwroga['name']}[{$idwroga['galaxy']}:{$idwroga['system']}:{$idwroga['planet']}]".gmdate("d-m-Y H:i:s",time())."</td></tr><tr><td>Metal:</td><td>".pretty_number($idwroga['metal'])."</td><td>Crystal:</td><td>".pretty_number($idwroga['crystal'])."</td></tr> <tr><td>Deuter:</td><td>".pretty_number($idwroga['deuterium'])."</td> <td>Enerji:</td><td>".pretty_number($idwroga['energy_max'])."</td></tr> </table><table width=400><tr><td class=c colspan=6>Filo</td></tr>$mt$dt$lm$cm$kr$ow$colon$recek$spysonda$bombo$satki$niszcz$gwiazdeczka$panc </table> <table width=400><tr><td class=c colspan=4>Defans</td></tr>$ml$sl$bl$gauss$ionic$buster$mp$dp </table> <table width=400><tr><td class=c colspan=6>Binalar</td></tr></tr>$kop_metal$kop_krysia$kop_deut$solar$fusion$robot$nano$stocznia$mag_mety$mag_krysi$mag_deut$lab$tetra$allydepo$silos</table>";

if($szpiegwrog['spy_tech'] > "0"){$spy_tech="<td>Casus Teknigi</td><td>{$szpiegwrog['spy_tech']}</td>";}
if($szpiegwrog['computer_tech'] > "0"){$pc_tech="<td>Bilgisayar Teknigi</td><td>{$szpiegwrog['computer_tech']}</td></tr>";}
if($szpiegwrog['military_tech'] > "0"){$boj_tech="<td>Silah Teknigi</td><td>{$szpiegwrog['military_tech']}</td>";}
if($szpiegwrog['defence_tech'] > "0"){$obr_tech="<td>Defans Teknolojisi</td><td>{$szpiegwrog['defence_tech']}</td></tr>";}
if($szpiegwrog['shield_tech'] > "0"){$op_tech="<td>Korunma Teknigi</td><td>{$szpiegwrog['shield_tech']}</td>";}
if($szpiegwrog['energy_tech'] > "0"){$ene_tech="<td>Enerji Teknolojisi</td><td>{$szpiegwrog['energy_tech']}</td></tr>";}
if($szpiegwrog['hyperspace_tech'] > "0"){$nadp_tech="<td>Hiper Uzay Teknigi</td><td>{$szpiegwrog['hyperspace_tech']}</td>";}
if($szpiegwrog['combustion_tech'] > "0"){$spal_tech="<td>Motor Gelistirme Teknigi</td><td>{$szpiegwrog['combustion_tech']}</td></tr>";}
...
if($szpiegwrog['laser_tech'] > "0"){$las_tech="<td>Lazer Teknolojisi</td><td>{$szpiegwrog['laser_tech']}</td>";}
...
if($szpiegwrog['graviton_tech'] > "0"){$gra_tech="<td>Gravitasyon Teknigi</td><td>{$szpiegwrog['graviton_tech']}</td>";}

$badania="<table width=400><tr><td class=c colspan=4> Hammadde {$idwroga['name']}[{$idwroga['galaxy']}:{$idwroga['system']}:{$idwroga['planet']}]".gmdate("d-m-Y H:i:s",time())."</td></tr><tr><td>Metal:</td><td>".pretty_number($idwroga['metal'])."</td><td>Crystal:</td><td>".pretty_number($idwroga['crystal'])."</td></tr> <tr><td>Deuter:</td><td>".pretty_number($idwroga['deuterium'])."</td> <td>Enerji</td><td>".pretty_number($idwroga['energy_max'])."</td></tr> </table><table width=400><tr><td class=c colspan=6>Filo</td></tr>$mt$dt$lm$cm$kr$ow$colon$recek$spysonda$bombo$satki$niszcz$gwiazdeczka$panc </table> <table width=400><tr><td class=c colspan=4>Obrona</td></tr>$ml$sl$bl$gauss$ionic$buster$mp$dp </table> <table width=400><tr><td class=c colspan=6>Bina</td></tr></tr>$kop_metal$kop_krysia$kop_deut$solar$fusion$robot$nano$stocznia$mag_mety$mag_krysi$mag_deut$lab$tetra$allydepo$silos</table><table width=400><tr><td class=c colspan=4>Arastirma   </td></tr></tr>$spy_tech$pc_tech$boj_tech$obr_tech$op_tech$ene_tech$nadp_tech$spal_tech$imp_tech$napna_tech$las_tech$jon_tech$plaz_tech$msbn_tech$gra_tech</table>";
...
doquery("INSERT INTO {{table}} SET
                     ...
                     `message_time`='".time()."',
                     `message_type`='0',
                     `message_from`='Casus Raporu',
                     `message_subject`='Yabanci Filo (Casusluk Yapiyor)',
                     `message_text`=' {$messmoja['name']} gelen filo {$idwroga['name']} dogru gidiyor '"
                     ,'messages');              
doquery("UPDATE {{table}} SET new_message=new_message+1 WHERE id='{$idwrog}'",'users'); 
doquery("UPDATE {{table}} SET fleet_mess='1' WHERE fleet_id=".$f["fleet_id"],'fleets');
}
...
doquery("INSERT INTO {{table}} SET
                     ...
                     `message_text`='Obca Flota z planety {$messmoja['name']} zawita³a na planecie {$idwroga['name']}'"
                     ,'messages');              
doquery("UPDATE {{table}} SET new_message=new_message+1 WHERE id='{$idwrog}'",'users'); 
doquery("UPDATE {{table}} SET fleet_mess='1' WHERE fleet_id=".$f["fleet_id"],'fleets');
}
...
doquery("INSERT INTO {{table}} SET
                     ...
                     `message_text`='Kolonizacja nie powiod³a siê, poniewa¿ masz ju¿ 9 planet...'"
                     ,'messages');              
doquery("UPDATE {{table}} SET new_message=new_message+1 WHERE id='{$f['fleet_owner']}'",'users'); 
 }else
if(make_planet($f['fleet_end_galaxy'],$f['fleet_end_system'],$f['fleet_end_planet'],$f['fleet_owner']))
		...
		//query para agregar un mensaje
			doquery("INSERT INTO {{table}} SET 
				...
				`message_from`='Dowództwo Floty',
				`message_subject`='Kolonizacja',
				`message_text`='Planeta skolonizowana'"
				,'messages');
					}else{echo "error";}
					/*doquery("DELETE FROM {{table}} WHERE fleet_id=".$f["fleet_id"],'fleets');
					doquery("UPDATE {{table}} SET

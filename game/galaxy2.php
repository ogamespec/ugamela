...
//		$playerrow = doquery("SELECT * FROM {{table}} WHERE id = '".$lunarow["id_owner"]."'","users",true);
  ...
  if($nieaktplanetquery['id'] != $user['id'])
	  {$szpiegowanie = "<a href=\'javascript:doit(6, $g, $s, $i, 1, {$user["spio_anz"]});\'>Casusluk</a><br /><br />";}
  elseif($nieaktplanetquery['id'] == $user['id'])
		  {$szpiegowanie = "";}
   if($nieaktplanetquery['id'] != $user['id'])
	  {$atakowanie = "<a href=\'fleet.php?galaxy=$g&amp;system=$s&amp;planet=$i&amp;planettype=1&amp;target_mission=1\'>Saldirmak</a><br />";}
  elseif($nieaktplanetquery['id'] == $user['id'])
		  {$atakowanie = "";}
     if($nieaktplanetquery['id'] != $user['id'])
	  {$zatrzymaj = "<a href=\'fleet.php?galaxy=$g&system=$s&planet=$i&planettype=1&target_mission=2\'>Durmak</a><br />";}
  elseif($nieaktplanetquery['id'] == $user['id'])
		  {$zatrzymaj = "";}
    if($nieaktplanetquery['id'] == $user['id'])
	  {$stacjonuj = "<a href=\'fleet.php?galaxy=$g&system=$s&planet=$i&planettype=1&target_mission=4\'>Deploy</a><br />";}
  elseif($nieaktplanetquery['id'] != $user['id'])
		  {$stacjonuj = "";}
  $transportuj = "<a href=\'fleet.php?galaxy=$g&system=$s&planet=$i&planettype=1&target_mission=3\'>Transport</a>";
  
  ?>
<a style="cursor: pointer;" onmouseover="this.T_WIDTH=250;this.T_OFFSETX=-110;this.T_OFFSETY=-30;this.T_STICKY=true;this.T_TEMP=<?php $T_TEMP = $user["settings_tooltiptime"]*1000; echo $T_TEMP; ; ?>;this.T_STATIC=true;return escape('<table width=\'240\'><tr><td class=\'c\' colspan=\'2\'>Gezegen Ismi <?php echo $planetrow["name"]." [$g:$s:$i]"; ?></td></tr><tr><th width=\'80\'><img src=\'<?php echo $dpath."planeten/small/s_".$planetrow["image"].".jpg"; ?>\' height=\'75\' width=\'75\'/></th><th style=\'text-align: left\'> <?php echo $szpiegowanie; ?> <?php echo $atakowanie; ?> <?php echo $zatrzymaj; ?> <?php echo $stacjonuj; ?> <?php echo $transportuj; ?></th></tr></table>');">
...
<?   
  ...
  if($nieaktmoonquery['id_owner'] != $user['id'])
	  {$szpiegowaniem = "<a href=\'floten3.php?galaxy=$g&system=$s&planet=$i&planettype=3&target_mission=6\'>Casusluk</a><br /><br />";}
  elseif($nieaktmoonquery['id_owner'] == $user['id'])
		  {$szpiegowaniem = "";}
   if($nieaktmoonquery['id_owner'] != $user['id'])
	  {$atakowaniem = "<a href=\'fleet.php?galaxy=$g&system=$s&planet=$i&planettype=3&target_mission=1\'>Saldirmak</a><br />";}
  elseif($nieaktmoonquery['id_owner'] == $user['id'])
		  {$atakowaniem = "";}
     if($nieaktmoonquery['id_owner'] != $user['id'])
	  {$zatrzymajm = "<a href=\'fleet.php?galaxy=$g&system=$s&planet=$i&planettype=3&target_mission=2\'>Durmak</a><br />";}
  elseif($nieaktmoonquery['id_owner'] == $user['id'])
		  {$zatrzymajm = "";}
    if($nieaktmoonquery['id_owner'] == $user['id'])
  ...
  elseif($nieaktmoonquery['id_owner'] != $user['id'])
		  {$stacjonujm = "";}
  if($nieaktmoonquery['id_owner'] != $user['id'])
	  {$niszczm = "<a href=\'fleet.php?galaxy=$g&system=$s&planet=$i&planettype=3&target_mission=5\'>Yoketmek</a><br />";}
  elseif($nieaktmoonquery['id_owner'] == $user['id'])
		  {$niszczm = "";}
  ...
  ?>
<a href="fleet.php?galaxy=<?php echo $g; ?>&amp;system=<?php echo $s; ?>&amp;planet=<?php echo $i; ?>&amp;planettype=3&amp;target_mission=3" style="cursor: pointer;" onmouseover="this.T_WIDTH=250;this.T_OFFSETX=-110;this.T_OFFSETY=-110;this.T_STICKY=true;this.T_TEMP=<?php $T_TEMP = $user["settings_tooltiptime"]*1000; echo $T_TEMP; ; ?>;return escape('<table width=\'240\'><tr><td class=\'c\' colspan=\'2\'>Ay <?php echo $lunarow["name"]; ?> <?php echo "[$g:$s:$i]"; ?></td></tr><tr><th width=\'80\'><img src=\'<?php echo $dpath; ?>planeten/mond.jpg\' height=\'75\' width=\'75\' alt=\'T\'/></th><th><table><tr><td class=\'c\' colspan=\'2\'>Özellikler:</td></tr><tr><th>Büyüklük:</th><th><?php echo number_format($lunarow["diameter"],0, '', '.'); ?></th></tr><tr><th>Özellik:</th><th><?php echo number_format($lunarow["temp_min"],0, '', '.'); ?></th></tr><tr><td class=\'c\' colspan=\'2\'>Görev:</tr><tr><th colspan=\'2\' style=\'text-align: left\'><?php echo $szpiegowaniem; ?> <?php echo $transportujm; ?> <?php echo $stacjonujm; ?> <?php echo $atakowaniem; ?> <?php echo $zatrzymajm; ?> <?php echo $niszczm; ?></tr></table></th></tr></table>');">
...
?>background-image: none;" width="30">
	...
	<a href="fleet.php?galaxy=<?php echo $g; ?>&amp;system=<?php echo $s; ?>&amp;planet=<?php echo $i; ?>&amp;planettype=2&amp;target_mission=8" style="cursor: pointer;" onmouseover="this.T_WIDTH=250;this.T_OFFSETX=-110;this.T_OFFSETY=-110;this.T_STICKY=true;this.T_TEMP=<?php $T_TEMP = $user["settings_tooltiptime"]*1000; echo $T_TEMP; ; ?>;return escape('<table width=\'240\'><tr><td class=\'c\' colspan=\'2\'>Harabe Alani <?php echo "[$g:$s:$i]"; ?></td></tr><tr><th width=\'80\'><img src=\'<?php echo $dpath; ?>planeten/debris.jpg\' height=\'75\' width=\'75\' alt=\'T\'/></th><th><table><tr><td class=\'c\' colspan=\'2\'>Hammadde:</td></tr><tr><th>Metal:</th><th><?php echo number_format($galaxyrow["metal"],0, '', '.'); ?></th></tr><tr><th>Crystal:</th><th><?php echo number_format($galaxyrow["crystal"],0, '', '.'); ?></th></tr><tr><td class=\'c\' colspan=\'2\'>Görev:</tr><tr><th colspan=\'2\' style=\'text-align: left\'><a href=\'javascript:doit(8, <?php echo $g; ?>, <?php echo $s; ?>, <?php echo $i; ?>, 1, <?php echo $user["spio_anz"]?>);\'>Sökmek</a></tr></table></th></tr></table>');">
...
elseif($nieaktplanetquery['authlevel'] == 0)
	  {$admin = "";}
?>
<a style="cursor: pointer;" onmouseover="this.T_WIDTH=200;this.T_OFFSETX=-20;this.T_OFFSETY=-30;this.T_STICKY=true;this.T_TEMP=<?php $T_TEMP = $user["settings_tooltiptime"]*1000; echo $T_TEMP; ; ?>;return escape('<table width=\'190\'><tr><td class=\'c\' colspan=\'2\'>Oyuncu Ismi :<?php echo $playerrow["username"];?> <?php echo $status3;?> <?php echo $status4;?></td></tr><tr><td><a href=\'messages.php?mode=write&id=<?php echo $playerrow["id"];?>\'>Mesaj Yaz</a></td></tr><tr><td><a href=\'buddy.php?a=2&u=<?php echo $playerrow["id"];?>\'>Arkadaslik Basvurusu</a></td></tr></table>');"><?php echo $status;?><?php echo $playerrow["username"];?></span> <?php echo $status6;?><?php echo $status;?><?php echo $status2;?><?php echo $status7;?> <?php echo $admin;?></span></a>
...
if($allyquery["ally_web"] != '')
	...
	if($allyquery){
		...
		echo "<a style=\"cursor:pointer\" onmouseover=\"this.T_WIDTH=250;this.T_OFFSETX=-30;this.T_OFFSETY=-30;this.T_STICKY=true;this.T_TEMP=5000;return escape('&lt;table width=\'240\'&gt;&lt;tr&gt;&lt;td class=\'c\'&gt;Ittifak Ismi : ".$allyquery['ally_name']." Toplam Uye :".$members_count[0]. "&gt;&lt;th&gt;&lt;table&gt;&lt;tr&gt;&lt;td&gt;&lt;a href=\'alliance.php?mode=ainfo&a=".$allyquery['id']."\'&gt;Ittifak Bilgileri&lt;/a&gt;&lt;/td&gt;&lt;/tr&gt;&lt;tr&gt;&lt;td&gt;&lt;a href=\'stat.php?start=101&who=ally\'&gt;Ittifak Siralamasi&lt;/a&gt;&lt;/td&gt;&lt;/tr&gt;&lt;tr&gt;&lt;td&gt;&lt;a href=\'".$allyquery["ally_web"]."\' target=\'_new\'&gt;$allywww &lt;/td&gt;&lt;/tr&gt;&lt;/table&gt;&lt;/th&gt;&lt;/table&gt;');\">";
...
if($user["settings_mis"] == "1" and $mojaplaneta['silo'] > 3 and $odlegloscsystem <= $zrmp){
		?>
<a href="fleet.php?galaxy=<?php echo $g; ?>&system=<?php echo $s; ?>&planet=<?php echo $i; ?>&planettype=1&target_mission=X"><img src="<?php echo $dpath; ?>img/r.gif" alt="Gezegenler Arasi Roket" title="Gezegenler Arasi Roket" border="0"></a>
		<?php
	}
	if($user["settings_esp"] == "1"){
		...
		?>"><img src="<?php echo $dpath; ?>img/e.gif" alt="Casusluk" title="Casusluk" border="0"></a>
		<?php
	}
	if($user["settings_wri"] == "1"){
		?>
<a href="messages.php?mode=write&id=<?php echo $playerrow["id"];?>"><img src="<?php echo $dpath; ?>img/m.gif" alt="Mesaj Yaz" title="Mesaj Yaz" border="0"></a>
		<?php
	}
	if($user["settings_bud"] == "1"){
		?>
<a href="buddy.php?a=2&amp;u=<?php echo $playerrow["id"];?>"><img src="<?php echo $dpath; ?>img/b.gif" alt="Arkadaslik Basvurusu" title="Arkadaslik Basvurusu" border="0"></a>
<?php	}
  }
?></th>
</tr>
 ...
 */
  ...
  case "603":
    ...
    break;
  case "604":
    addToTable("User jest za mocny dla ciebie", "error");
    break;
  case "605":
    addToTable("Nie mozna skanowac Usery bedacych na urlopie", "vacation");
    break;
  case "610":
...
function doit(order, galaxy, system, planet, planettype, shipcount){
  	if(order==6)	
	strInfo = "Gonderildi "+shipcount+" "+(shipcount>1?"Casus Sondasi":"Casus Sondasi")+" Kordinat "+galaxy+":"+system+":"+planet+"...";
   if(order==8)	
	strInfo = "Gonderildi"+shipcount+" "+(shipcount>1?"Geri Donusumcu":"Geri Donusumcu")+" Kordinattaki Harabe "+galaxy+":"+system+":"+planet+"...";
  ...
  <tbody><tr>
    <td>
      ...
      <td>
       <table>
        <tbody><tr>
         <td class="c" colspan="3">System</td>
        </tr>
         <tr>
      ...
      <tr>
        <td colspan="2" align="center"> <input value="Display" type="submit"></td>
      </tr>
     </tbody></table>
</form>
   <table width="569">
<tbody><tr>
  <td class="c" colspan="8">System<?php echo "$galaxy:$system"; ?></td>
</tr>
   <tr>
    <td class="c">Sira</td>
    <td class="c">Gezegen</td>
    <td class="c">Gezegen Ismi</td>
    <td class="c">Ay</td>
    <td class="c">Harabe</td>
    <td class="c">Kullanici Adi</td>
    <td class="c">Ittifak</td>
 <td class="c">Aksiyonlar</td>   </tr>
    <?php echo_galaxy($galaxy,$system); ?>
<tr>
<td class="c" colspan="6">( <?php
  if($planetcount==1){
    echo "$planetcount Zamieszka³a Planeta";
  }elseif($planetcount==0){
    echo "Nie zamieszka³y uk³ad";
  }else{
    echo "$planetcount Gezegende Yerlesim Var";
  }
?> )</td>
<td class="c" colspan="2"><a href="#" onmouseover="this.T_WIDTH=150;return escape('<table><tr><td class=\'c\' colspan=\'2\'>Bilgilendirme</td></tr><tr><td width=\'125\'>Guclu Oyuncu</td><td><span class=\'strong\'>d</span></td></tr><tr><td>Zayif Oyuncu</td><td><span class=\'noob\'>s</span></td></tr><tr><td>Tatilde</td><td><span class=\'vacation\'>u</span></td></tr><tr><td>Cezali Oyuncu</td><td><span class=\'banned\'>g</span></td></tr><tr><td>7 Gundur Kullanilmiyo</td><td><span class=\'inactive\'>i</span></td></tr><tr><td>28 Gundur Kullanilmiyo</td><td><span class=\'longinactive\'>I</span></td></tr><tr><td>Admin</td><td><font color=\'lime\'><blink>A</font></blink></td></tr></table>')">Bilgilendirme</a></td>
</tr>
<tr>
<td class="c" colspan="4">
<span id="missiles"><?php echo "$rmp"; ?></span> : Gezegenler Arasi Roket</td><td class="c" colspan="2">
<span id="slots"><?php echo "$maxfleet_count"; ?></span> / <?php echo "$fleetmax"; ?> Filo Kotasi</td><td class="c" colspan="2">
<span id="recyclers"><?php echo "$recek"; ?></span>: Geri Donusumcu<br><span id="probes"><?php echo "$probes"; ?></span>: Casus Sondasi</td>
</tr>
